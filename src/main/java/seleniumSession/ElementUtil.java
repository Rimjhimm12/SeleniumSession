...
public class ElementUtil {
	 ...
	 * @return
	 */
	public List<WebElement> waitForFluentWaitElementPresence(By locator, int timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
	 ...
	 * match the locators are visible. Visibility means that the elements are not
	 ...
	 * @return
	 */
	public List<WebElement> waitForFluentWaitElementVisible(By locator, int timeOut) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
